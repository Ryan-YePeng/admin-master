<template>
  <div class="picture-cropper-uploader">
    ...
    >
      ...
      <i
        v-else
        class="el-icon-plus picture-uploader-icon"
        :style="
          'width:' +
            width +
            ';height:' +
    ...
    >
      <div class="cropper-content">
        ...
        <div
          class="show-preview"
          :style="
            'width:180px;overflow:hidden;margin:5px;height:' +
              (180 * this.fixedNumber[1]) / this.fixedNumber[0] +
              'px'
          "
        >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="finish" :loading="isLoadingButton"
          >确认</el-button
        >
